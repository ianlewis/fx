...
def update_all(base_dir, start_date, end_date, logger):
    currencies = update_currencies(base_dir, start_date, end_date, logger)
...
def update_currencies(base_dir, start_date, end_date, logger):
...
def main():
    ...
    update_all(args.out, args.start, args.end, logger)
